...
4. Once finished, got to the folder "Project Submits" that is in your forked repository.
5. Create a folder with your full name and drag your code files into that folder. (or email to scarlett acc)
